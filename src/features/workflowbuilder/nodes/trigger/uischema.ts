        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              type: "DatePicker",
              scope: scope(
                "properties.timeSchedule.properties.starts.properties.date",
              ),
            },
            {
              type: "Text",
              scope: scope(
                "properties.timeSchedule.properties.starts.properties.time",
              ),
              placeholder: "--:--",
              rule: {
                effect: "SHOW",
        ...
        },
        {
          ...
          elements: [
            ...
            },
            {
              type: "DatePicker",
              scope: scope(
                "properties.timeSchedule.properties.ends.properties.date",
              ),
            },
            {
              rule: {
              ...
              type: "Text",
              scope: scope(
                "properties.timeSchedule.properties.ends.properties.time",
              ),
              placeholder: "--:--",
            },
          ],
        },
        {
          ...
          elements: [
            ...
            },
            {
              type: "Select",
              scope: scope(
                "properties.timeSchedule.properties.allDayFrequency",
              ),
